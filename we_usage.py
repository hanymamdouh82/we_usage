...
LOGIN_URL = f"{BASE_URL}/echannel/service/besapp/base/rest/busiservice/v1/auth/userAuthenticate"
USAGE_URL = f"{BASE_URL}/echannel/service/besapp/base/rest/busiservice/cz/cbs/bb/queryFreeUnit"
